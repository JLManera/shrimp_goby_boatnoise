...
```{r}
goby_out_plot3
ggsave("./2-figs/goby_out_plot3.jpeg", plot = goby_out_plot3, units = "px", width = 2200, height = 1400, dpi = 300)
ggsave("./2-figs/goby_out_plot3.pdf", plot = goby_out_plot3, units = "px", width = 2200, height = 1400)
```
...
shrimp_out_plot3
ggsave("./2-figs/shrimp_out_plot3.jpeg", plot = shrimp_out_plot3, units = "px", width = 2200, height = 1400, dpi = 300)
ggsave("./2-figs/shrimp_out_plot3.pdf", plot = shrimp_out_plot3, units = "px", width = 2200, height = 1400)
```
...
ggsave("./2-figs/shrimp_contact_fig_together.png", plot = shrimp_contact_fig_together, units = "px", width = 2200, height = 1400, dpi = 300)
```
...
ggsave("./2-figs/shrimp_contact_plot3.jpeg", plot = shrimp_contact_plot3, units = "px", width = 2200, height = 1400, dpi = 300)
ggsave("./2-figs/shrimp_contact_plot3.pdf", plot = shrimp_contact_plot3, units = "px", width = 2200, height = 1400)
```
