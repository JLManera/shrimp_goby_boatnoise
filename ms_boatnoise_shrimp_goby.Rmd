...
write_csv(model_estimates, "./2-figures/supplementary_tables/Table_S2.csv")
```
...
write_csv(goby_out_contrasts_table, "./2-figures/supplementary_tables/Table_S3.csv")
...
write_csv(shrimp_out_contrasts_table, "./2-figures/supplementary_tables/Table_S4.csv")
...
write_csv(shrimp_contact_contrasts_table, "./2-figures/supplementary_tables/Table_S5.csv")
```
...
loo_compare(goby_out_model, cumulative_sum_goby_out_model)
```
...
```{r}
emtrends(cumulative_sum_goby_out_model, ~ 1, var = "cum_sum_boat_trials_per_site", epred = TRUE, re_formula = NA)
```
...
loo_compare(shrimp_out_model, cumulative_sum_shrimp_out_model)
```
...
```{r}
emtrends(cumulative_sum_shrimp_out_model, ~ 1, var = "cum_sum_boat_trials_per_site", epred = TRUE, re_formula = NA)
```
...
loo_compare(shrimp_contact_model, cumulative_sum_shrimp_contact_model)
```
...
```{r}
emtrends(cumulative_sum_shrimp_contact_model, ~ 1, var = "cum_sum_boat_trials_per_site", epred = TRUE, re_formula = NA)
```
